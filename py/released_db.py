...
class ReleasedModel():
    ...
    def insert_cds(self, books_list: list):
        """
            CD情報をインサートする
        """

        sql = '''
            INSERT INTO cds_item (
                title, page_url, genre, genre_detail, author, relation_item, selling_agency, distributor,
                disc_count, music_count, record_time, cd_number, jan, in_store_code, release_date, image_url, description,
        ...
        try:
            for n in range (len(books_list)):
                insert_data.append((
                    ...
                    books_list[n]['music_count'],
                    books_list[n]['record_time'],
                    books_list[n]['cd_number'],
                    books_list[n]['jan'],
                    books_list[n]['in_store_code'],
                    books_list[n]['release_date'],
                    books_list[n]['image_url'],
                    books_list[n]['description'],
                    books_list[n]['rakuten_affiliate_url'],
            ...
            # コミット
            self.__connection.commit()
            print(f"{self.__cursor.rowcount} records inserted for cds_item tables")
            self.__cursor.close()
