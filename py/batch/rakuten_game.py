...
def run(playwright: Playwright):
    ...
    with get_my_chrome(playwright) as chrome:
        ...
        with chrome.new_page() as page:
            ...
            # 006 (ゲーム)
            # url = "https://books.rakuten.co.jp/calendar/006514/monthly/?tid=2023-02-01&v=2&s=14"
            ...
            while is_next:
                ...
                # for n in range(1):
                    ...
                    games_info["title"] = title_selector.inner_text() if title_selector.is_visible() else ""
