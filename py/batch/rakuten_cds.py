    ...
    with sync_playwright() as p:
        ...
        while is_next_page:
            ...
            for n in range(cd_list.count()):
                ...
                cds_info["title"] = title_selector.inner_text() if title_selector.is_visible() else ""
                ...
                cds_info["release_date"]  = release_date_selector.inner_text() if release_date_selector.is_visible() else ""
